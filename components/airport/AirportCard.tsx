import { Avatar, Card, CardActions, CardHeader, CardMedia, Collapse, createStyles, IconButton, makeStyles } from '@material-ui/core';
...
const AirportCard: FC<Props> = ({airport}) => {
    ...
    return (
        <Card className={card} onClick={toggleExpanded}>
            <CardHeader
                avatar={
                    <Avatar className={cardHeaderAvatar}>
                        {code}
                    </Avatar>
                }
                title={description}
